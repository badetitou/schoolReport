...
Pour cela, un travail préliminaire a été mené en Projet de Fin d’Études (PFE) où l’on a étudié une application de démonstration (application _"bac à sable"_) qui reprend les principes d’organisation des applications de Berger-Levrault.
