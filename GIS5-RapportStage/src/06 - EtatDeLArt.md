...
Gotti _et al._ [@gotti2016java] utilisent une stratégie mixe pour l'analyse d'applications écrites en Java.
...
Ce travail est lié à notre problématique d'exportation des méta-modèle.
...
Gotti _et al._[@gotti2016java] ont proposé un méta-modèle inspiré du modèle KDM (voir la Section \ref{sec:kdm}).
...
Smair _et al._[@samir2007swing2script] ont travaillé sur la migration de l'application Java-Swing vers l'application web Ajax.
...
Elle est divisée en douze paquetages organisés en quatre couches.
...
Brambilla _et al._ [@brambilla2014interaction] ont défini le langage IFML (Interaction Flow Modeling Language) pour représenter une l'interface graphique d'une application.
